...
public class SchemaUpgradeService(AppDbContext dbContext) : ISchemaUpgradeService
{
  public async Task ApplyAsync(CancellationToken cancellationToken = default)
  {
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "TemporaryReference" character varying(48) NOT NULL DEFAULT '';
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "ScreeningStatus" character varying(24) NOT NULL DEFAULT 'CLEAR';
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "HasRestrictiveScreeningMatch" boolean NOT NULL DEFAULT FALSE;
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "ScreeningDetailsJson" text NOT NULL DEFAULT '{{}}';
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "KycComment" text NULL;
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "KycReference" character varying(64) NULL;
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "KycApprovedAtUtc" timestamp without time zone NULL;
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      ALTER TABLE "OnboardingRecords"
      ADD COLUMN IF NOT EXISTS "KycRejectedAtUtc" timestamp without time zone NULL;
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE INDEX IF NOT EXISTS "IX_OnboardingRecords_Status_BranchCode"
      ON "OnboardingRecords" ("Status", "BranchCode");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE INDEX IF NOT EXISTS "IX_OnboardingRecords_Psut"
      ON "OnboardingRecords" ("Psut");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE TABLE IF NOT EXISTS "PasswordManagedSystems" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        "Name" character varying(120) NOT NULL,
        "NormalizedName" character varying(120) NOT NULL,
        "IsActive" boolean NOT NULL DEFAULT TRUE,
        "CreatedAtUtc" timestamp with time zone NOT NULL DEFAULT NOW(),
        "CreatedByUserName" character varying(150) NOT NULL DEFAULT 'system',
        "UpdatedAtUtc" timestamp with time zone NOT NULL DEFAULT NOW(),
        "UpdatedByUserName" character varying(150) NOT NULL DEFAULT 'system'
      );
      """,
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE UNIQUE INDEX IF NOT EXISTS "IX_PasswordManagedSystems_NormalizedName"
      ON "PasswordManagedSystems" ("NormalizedName");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      INSERT INTO "PasswordManagedSystems" ("Name", "NormalizedName", "IsActive", "CreatedAtUtc", "CreatedByUserName", "UpdatedAtUtc", "UpdatedByUserName")
      VALUES
        ('Flexcube Core banking', 'FLEXCUBE CORE BANKING', TRUE, NOW(), 'system', NOW(), 'system'),
        ('Check Point System', 'CHECK POINT SYSTEM', TRUE, NOW(), 'system', NOW(), 'system'),
        ('Webmail', 'WEBMAIL', TRUE, NOW(), 'system', NOW(), 'system'),
        ('BI Report', 'BI REPORT', TRUE, NOW(), 'system', NOW(), 'system')
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      ...
      CREATE TABLE IF NOT EXISTS "WatchlistEntries" (
        ...
        "FullName" character varying(240) NOT NULL,
        "NormalizedName" character varying(240) NOT NULL,
        "AlternateNames" text,
        "ScreeningCategory" character varying(40) NOT NULL,
        "SourceList" character varying(160) NOT NULL,
        "SourceReference" character varying(160),
        "RiskLevel" character varying(40),
        "Nationality" character varying(120),
        "DateOfBirth" date,
        "PlaceOfBirth" character varying(160),
        "DocumentType" character varying(100),
        "DocumentNumber" character varying(160),
        "PositionOrRole" character varying(240),
        "Organization" character varying(240),
        "Country" character varying(120),
        "CityOrRegion" character varying(160),
        "Address" text,
        "ListedOn" date,
        "ExpiryDate" date,
        "IsActive" boolean NOT NULL DEFAULT TRUE,
        ...
        "RequiresEnhancedDueDiligence" boolean NOT NULL DEFAULT FALSE,
        "Remarks" text,
        "SourceUrl" character varying(500),
        "SourceDataJson" text,
        "ImportedFileName" character varying(260),
        "SourceRowNumber" integer,
        "CreatedByUserName" character varying(150),
        "UpdatedByUserName" character varying(150),
        "CreatedAtUtc" timestamp with time zone NOT NULL DEFAULT NOW(),
        "UpdatedAtUtc" timestamp with time zone NOT NULL DEFAULT NOW()
      );
      """,
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE UNIQUE INDEX IF NOT EXISTS "IX_WatchlistEntries_EntryKey"
      ON "WatchlistEntries" ("EntryKey");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE INDEX IF NOT EXISTS "IX_WatchlistEntries_NormalizedName"
      ON "WatchlistEntries" ("NormalizedName");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE INDEX IF NOT EXISTS "IX_WatchlistEntries_IsActive_ScreeningCategory"
      ON "WatchlistEntries" ("IsActive", "ScreeningCategory");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE INDEX IF NOT EXISTS "IX_WatchlistEntries_SourceReference"
      ON "WatchlistEntries" ("SourceReference");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE UNIQUE INDEX IF NOT EXISTS "IX_SystemPermissions_Code"
      ON "SystemPermissions" ("Code");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      ...
      CREATE TABLE IF NOT EXISTS "RolePermissions" (
        ...
        "PermissionId" integer NOT NULL REFERENCES "SystemPermissions" ("Id") ON DELETE CASCADE,
        "AssignedAtUtc" timestamp with time zone NOT NULL DEFAULT NOW(),
        "AssignedByUserName" character varying(150) NOT NULL DEFAULT 'system'
      );
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      CREATE UNIQUE INDEX IF NOT EXISTS "IX_RolePermissions_Role_PermissionId"
      ON "RolePermissions" ("Role", "PermissionId");
      """,
      cancellationToken
    );
    ...
    await dbContext.Database.ExecuteSqlRawAsync(
      """
      INSERT INTO "SystemPermissions" ("Code", "Name", "Description", "IsActive", "CreatedAtUtc", "UpdatedAtUtc")
      VALUES (
        'ALL_BRANCH_ACCESS',
        'All Branch Access',
        'Allows a maker or checker to work with resource mobilization records across every branch.',
        TRUE,
        NOW(),
        NOW()
      )
